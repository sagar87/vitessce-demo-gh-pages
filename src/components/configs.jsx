export const myViewConfig = {
  "166_4_I2_KL.ome.tif": {
    ...
    description:
      "Periodic acid-Schiff stained microscopy collected from the right kidney.",
    public: true,
    datasets: [
      {
        ...
        files: [
          {
            ...
            url: "http://localhost:9000/166_4_I2_KL.ome.tif",
          },
        ],
      },
    ],
    ...
    datasets: [
      {
        ...
        files: [
          {
            fileType: "image.ome-tiff",
            url: "http://localhost:9000/166_1_E2_FL3a.ome.tiff",
          },
        ],
      },
    ],
